...
function myProfileColorService($mdDialog, config, $q, $http, userService) {
    ...
    return {
        ...
        saveColor: function (color) {
            ...
            var address = config.serviceUrl + 'api/color/' + userService.username;
            $http.post(address,
                {
                    "red": color.red,
                    "green": color.green,
...
module.exports = ['$mdDialog', 'config', '$q', '$http', 'userService', myProfileColorService];