...
function myProfilePictureController($mdDialog, config, Upload, userService, accountService, myProfilePictureService) {
    var vm = this;
    ...
    vm.upload = function () {
        ...
        Upload.upload({
            url: config.serviceUrl + 'api/uploading',
            data: {
...
module.exports = ['$mdDialog', 'config', 'Upload', 'userService', 'accountService', 'myProfilePictureService', myProfilePictureController];