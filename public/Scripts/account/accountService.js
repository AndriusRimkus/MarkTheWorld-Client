...
function accountService($http, config, $q, userService, facebookLoginService) {
    ...
    return {
        login: function (loginData) {
            ...
            $http.post(config.serviceUrl + '/api/User/Login',
                {
        ...
        register: function (registerData) {
            ...
            $http.post(config.serviceUrl + '/api/User',
                {
...
module.exports = ['$http', 'config', '$q', 'userService', 'facebookLoginService', accountService];
