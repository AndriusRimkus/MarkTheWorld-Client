...
function mapService($http, config, rectanglesService, markersService, userService) {
        var clickedPosition = {};
        var map;
        ...
        function init(m) {
            ...
            map.addListener('click', function(e) {
                ...
                marker.addListener('dragend', function (e) {
                    ...
                    $http.post(config.serviceUrl + '/api/dotCheck',
                        {
        ...
        function updateRecColors() {
            if (map.getZoom() >= recStartingZoom) {
                var url = config.serviceUrl + '/api/Squares';
        ...
        function drawMarkers() {
            var url = config.serviceUrl + '/api/Dots/' + map.getZoom();
...
module.exports = ['$http', 'config', 'rectanglesService', 'markersService', 'userService', mapService];